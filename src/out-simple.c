 ...
 ****************************************************************************/
static void
simple_out_open(struct Output *out, FILE *fp)
{
 ...
 ****************************************************************************/
static void
simple_out_close(struct Output *out, FILE *fp)
{
    char buffer[256];
    time_t now = time(0);
    struct tm tm;
 ...
 ****************************************************************************/
static void
simple_out_status(struct Output *out, FILE *fp, time_t timestamp, int status,
 ...
 ****************************************************************************/
static void
simple_out_banner(struct Output *out, FILE *fp, time_t timestamp,
...
/****************************************************************************
 ****************************************************************************/
const struct OutputType simple_output = {
    "txt",
    0,
    simple_out_open,
    simple_out_close,
